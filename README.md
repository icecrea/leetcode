...
关于学习笔记总结部分，请移步另一项目： [学习笔记传送门](https://github.com/icecrea/blog)
...
- [22.括号生成](./src/main/java/com/example/leetcode/backtrack/LeetCode022_GenerateParentheses.java)
- [39.组合总数](./src/main/java/com/example/leetcode/backtrack/LeetCode039_CombinationSum.java)
- [46.全排列](./src/main/java/com/example/leetcode/backtrack/LeetCode046_Permutations.java)
- [47.全排列2（包含重复）](./src/main/java/com/example/leetcode/backtrack/LeetCode047_Permutations2.java)
- [51.N皇后](./src/main/java/com/example/leetcode/backtrack/LeetCode051_NQueens.java)
- [77.组合](./src/main/java/com/example/leetcode/backtrack/LeetCode077_Combinations.java)
- [78.子集](./src/main/java/com/example/leetcode/backtrack/LeetCode078_Subsets.java)
- [79.搜索单词](./src/main/java/com/example/leetcode/backtrack/LeetCode079_SearchWord.java)
- [257.二叉树所有路径](./src/main/java/com/example/leetcode/backtrack/LeetCode257_binaryAllPaths.java)
...
### LeetCode官方算法精选
- [初级算法官网地址](https://leetcode-cn.com/explore/interview/card/top-interview-questions-easy/)
- [中级算法官网地址](https://leetcode-cn.com/explore/interview/card/top-interview-questions-medium/)
- [高级算法官网地址](https://leetcode-cn.com/explore/interview/card/top-interview-questions-hard/)

#### 初级算法49题： [初级算法文档](./src/main/java/com/example/topinterview/easy/README.md)
...
- [二叉查找类型题目总结](./src/main/java/com/example/summary/sortalgorithm/BinarySearch.java)
- [单调栈总结](./src/main/java/com/example/summary/MonotoneStack.java)
- [手写LRU](./src/main/java/com/example/summary/lru/LRUCache.java)
- [链表反转总结](./src/main/java/com/example/summary/linkedlist/ReverseSummary.java)
- [链表排序总结](./src/main/java/com/example/summary/linkedlist/SortSummary.java)
- [二叉树遍历方式总结](./src/main/java/com/example/summary/binarytree/BinaryTreeTraversal.java)
- [二叉搜索树题目总结](./src/main/java/com/example/summary/binarytree/BSTSummary.java)
